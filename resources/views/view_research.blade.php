    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <h1 class="text-2xl font-semibold text-gray-800">View Research</h1>
            </div>
            <p class="text-sm text-gray-500 ml-3">Detailed view of your research submission</p>
        </div>
