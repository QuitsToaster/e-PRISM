...
<div class="mb-6 flex items-center justify-between">
    <div>
        <div class="flex items-center gap-2 mb-1">
            ...
            <h1 class="text-2xl font-semibold text-gray-800">Submitted Researches</h1>
        </div>
        <p class="text-sm text-gray-500 ml-3">Review all submitted research papers</p>
    </div>
    <div class="flex items-center gap-3">
        <div class="text-right">
            <p class="text-xs text-gray-400">Total researches</p>
...
{{-- Table Card matching dashboard card style --}}
