...
<div class="max-w-3xl mx-auto mt-10 px-4">
    ...
    <!-- Profile Form - Single Card with Red to Blue Gradient Border and Hover Effect -->
    <div class="border-gradient-red-blue rounded-xl bg-white p-6 shadow-sm hover-card-effect">
        <form id="profile-form" action="{{ route('profile.update') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ auth()->user()->name }}"
                               class="w-full border border-gray-300 bg-white p-3 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 pb-6 relative">
                <div class="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-red-600 to-blue-600"></div>
                <h2 class="text-sm font-semibold text-blue-600 mb-4 flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Security Section -->
            <div class="mb-6">
                <h2 class="text-sm font-semibold text-purple-600 mb-4 flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
